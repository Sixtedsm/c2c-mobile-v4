...
import { fromLonLat, get as getProjection, toLonLat, transformExtent, transform as transformProjection } from 'ol/proj';
...
export default {
  ...
  proj: {
    ...
    transformExtent,
    toLonLat,
    // V4 — added so the planner / mini-app can drop lon/lat coords on
    // the map without hand-writing `transform([lon, lat], 4326, 3857)`
    // everywhere. fromLonLat is the standard OL helper.
    fromLonLat,
  },
